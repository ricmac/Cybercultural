---
title: "The Blogosphere Blossoms in 2003 As RSS Readers Catch On"
...
![NetNewsWire 1.0, 2003](/assets/images/netnewswire-2003-large.jpg){loading="eager"}
*The release of [NetNewsWire 1.0](https://inessential.com/2003/02/11/netnewswire_1_0_ships.html) in [February 2003](https://web.archive.org/web/20030201105606/http://ranchero.com/netnewswire/), one of the first popular RSS Readers.*

So far in my history of blogging and RSS, we've seen how weblogs [emerged in 1999](/p/blogs-rss-1999/) as a new form of personal journal, began to [link to each other in 2000](/p/blogs-rss-2000/) via blogrolls, [turned serious in 2001](/p/blogs-rss-2001/) with "warblogs," and then became an interconnected ecosystem called [the blogosphere in 2002](/p/blogs-rss-2002/). In 2003, blogging continued its evolution into a new form of media publication — helped greatly by the rapid adoption of RSS Readers.
...
![ReadWriteWeb homepage, 5 June 2003](/assets/images/rww-june2003-full.png)
*ReadWriteWeb homepage, [5 June 2003](https://web.archive.org/web/20030605151456/http://radio.weblogs.com/0105304/) (the earliest Wayback Machine copy).*
...
I used Radio Userland when I started RWW, but the following year [I switched to Movable Type](https://web.archive.org/web/20040701054525/http://www.readwriteweb.com/archives/001838.php). The beauty of the blogosphere at that point, though, was that you had complete control over your blogging tools. As I discussed at length in [my memoir](/p/roadmap-bubbleblog/), this would change with the rise of Web 2.0 and its [proprietary social networks](/p/internet-2007/) over the rest of the decade. In 2003, we didn't know how good we had it.

![BlogShares, April 2003](/assets/images/blogshares-april2003.png)
*A fun blog index called BlogShares [in April 2003](https://web.archive.org/web/20030402082044/http://www.blogshares.com/top500.php).* 
...
Google wasn’t yet a public company at this point, and had only recently begun to turn a profit — thanks to its AdWords online advertising system, [introduced in 2000](/p/karma-2000-slashdot-bowienet-v2/). But clearly it saw something promising in what Blogger was doing. Gillmor explained it well in his writeup:
...
![Megnut, February 2003](/assets/images/megnut-feb2003.png)
*Blogger co-founder Meg Hourihan's blog [days after](https://web.archive.org/web/20030220053327/https://megnut.com/) the Google acquisition.*

## Blogging Communities

Radio UserLand was a bit more complicated than software like Blogger and LiveJournal. It was a desktop client, had its own scripting language, and also included an RSS aggregator. It was the latter feature, an RSS Reader, that really opened my eyes to the wonders of the blogosphere. I discovered a bunch of other blogs that also ran on Radio Userland — including [Jon Udell's Weblog](https://web.archive.org/web/20030407165518mp_/http://weblog.infoworld.com/udell/) and Robert Scoble's [Scobleizer](https://web.archive.org/web/20030408030429/http://radio.weblogs.com/0001011/), but also lesser known Radio blogs that caught my imagination, like Lilia Efimova's [Mathemagenic](https://web.archive.org/web/20030613094422/http://blog.mathemagenic.com/) and Dina Mehta's [Conversations With Dina](https://web.archive.org/web/20030625011407/http://radio.weblogs.com/0121664/).

![Dina Mehta's blog, June 2003](/assets/images/conversations-with-dina-june2003.png)
*Dina Mehta's blog, June 2003.*
...
![WordPress, June 2003](/assets/images/wordpress-june-2003.png)
*[WordPress in June 2003](https://web.archive.org/web/20030618021947/http://wordpress.org/), a month after it launched.*
...
As I mentioned, Radio UserLand had an RSS reader in its desktop app. But there were several other options available, such as FeedDemon and NetNewsWire (both desktop readers, for Windows and Mac respectively). In mid-2003, a browser-based RSS Reader called [Bloglines](https://web.archive.org/web/20030704094052/http://www.bloglines.com/) launched; [by August I was a Bloglines user](https://web.archive.org/web/20040823060210/http://www.readwriteweb.com/2003/08/13.html#a97) and have used browser-based readers ever since.

![Bloglines, July 2003](/assets/images/bloglines-july2003.png)
*Bloglines homepage, July 2003.*

RSS syndication would become a crucial part of the blogging movement, because it enabled bloggers like me to be discovered and our content to be distributed across the internet. But in 2003, RSS was far from being a settled technology — it was an open standard that hadn’t yet worked out all the kinks. As noted in previous posts, there were [multiple versions of RSS](https://web.archive.org/web/20030703063636/https://www.tbray.org/ongoing/When/200x/2003/06/23/SamsPie) floating around at this point. The most popular in 2003 was RSS 2.0, created and run by Dave Winer, the proprietor of UserLand Software.

Partly in an effort to remove control of RSS from a single person or company, a community effort to create yet another RSS version began. The group behind this took a while to settle on a name; in August 2003, [Tim Bray referred to it](https://www.tbray.org/ongoing/When/200x/2003/08/18/PieSchema02) as "PEAW (Pie / Echo / Atom / Whatever)." But by December, Atom was the agreed name, and the 0.3 version had attracted support from the blogging ecosystem — most notably Google's Blogger.

![Atom presentation, November 2003](/assets/images/atom-api-goals-nov2003.png)
*Slide from a Mark Pilgrim presentation about Atom at Apachecon, [November 2003](https://web.archive.org/web/20060420152110/http://diveintomark.org/public/2003/11/atomapi.pdf).*
...
On [May 24, 2003](https://web.archive.org/web/20030524161156/http://www.scripting.com/), there was a post on Dave Winer’s weblog, Scripting News, that caught my eye. It was a link to an essay he’d written, entitled “Who will pay for software?” As a software developer, Winer was naturally concerned about his ability to earn a living from his work. “For the last few weeks I've been asking anyone who will listen if it isn't weird that our economy is based on software, more and more, yet users don't want to pay for software,” [he wrote](http://scripting.com/davenet/2003/05/24/whoWillPayForSoftware.html). He compared this situation to the music industry, where “songs travel freely over the Internet.”

![Scripting News, May 2003](/assets/images/scriptingnews-may2003.png)
*Dave Winer's Scripting News, May 2003.*

At the time, Winer was also a fellow at Harvard’s Berkman Center for Internet and Society. On May 29, he delivered a keynote at the third annual Open Source Content Management Conference ([OSCOM](https://web.archive.org/web/20030625234350/http://www.oscom.org/Conferences/Cambridge/)), hosted by the Berkman Center. He began by pushing back against the framing of companies like UserLand Software as “proprietary” or “closed.” He preferred the term “commercial software,” and added that “all the noise that people make about open source” had been “really destructive” to companies like his.
...
![Aaron Swartz website, May 2003](/assets/images/aaron-swartz-website-may2003.jpg)
*[Aaron Swartz's website](https://web.archive.org/web/20030525022344/http://www.aaronsw.com/), just before his trip to OSCOM in May 2003.*

Meanwhile, in the IRC backchannel, Swartz was doing an actual [live blog of Winer’s session](https://web.archive.org/web/20031204134855/http://www.aaronsw.com/2002/oscom-dwkeynote). According to his real-time notes, which were later published as a blog post, the OSCOM discussion got testy when one audience member said that Radio UserLand had “a support issue” and a “documentation issue.” Winer retorted that “there’s no damn money in software.” Soon after, there was a verbal confrontation between Winer and an audience member, Bill Kearney from the syndication startup Syndic8.com. This part of the keynote was cut out of the video that years later was [published on YouTube](https://www.youtube.com/watch?v=02c_mRDnP6Y), but Swartz live-blogged the carnage:
...
Was 2003 the start of a truly [two-way web](/p/one-year-blogging-anniversary-2004/), where users could just as easily write to the web as read it? I think it was! So it's an appropriate place to end this series on the history of blogging and RSS. If you have comments, well this isn't a blog...but you can tag me [on the fediverse](https://mastodon.social/@ricmac) — the closest thing we have today to the blogosphere of 2003.
