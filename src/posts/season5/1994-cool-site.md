---
title: "1994: Cool Site of the Day and the rise of curated web design"
...
![Cool Site of the Day screenshot](/assets/images/cotd-feature.png){loading="eager"}
*Cool Site of the Day; screenshot [via ​Megan Sapnar Ankerson](https://www.theatlantic.com/technology/archive/2014/07/how-coolness-defined-the-world-wide-web-of-the-1990s/374443/).*

On August 10, 1994, a 33-year old web enthusiast named Glenn Davis posted [the following announcement](https://groups.google.com/g/comp.infosystems.www.misc/c/KxkWnUnhyX8/m/0GzKCVcdLRwJ) to a UseNet mailing list:
...
![Cool Site of the Day, 1995](/assets/images/cool-site-of-the-day-1995b.jpg)
*1995 image of CSotD; via [World Wide Web Design Guide](https://archive.org/details/worldwidewebdesi00wils), a 1995 book by Stephen Wilson.*
...
Since the Web at this time wasn't very "designable" (to use his wording), the initial sites Davis chose "were primarily picked for showing new things or possibilities." The list of sites he selected in [that first month](https://web.archive.org/web/19961226220230/http://cool.infi.net/stillcool/still9408.html) included *The Tori Amos Home Page*, *Le WebLouvre*, *San Francisco Examiner*, *Future Fantasy Bookstore*, *The Froggy Page*, *Virtual Chevrolet*, and *The Monty Python Page*. So it was a mix of fan sites, experimental art pages, academic playgrounds, and very early commercial sites.

## Editorial web design

It didn't take long for Davis' website to become popular, partly because this was the era of the web directory — [Yahoo had launched](/p/1994-perl-yahoo/) earlier in 1994, but we were still several years away from [quality search engines](/p/search-1998/). Perhaps the closest thing to CSotD when it launched was Mozilla's 'What's New' page, but that was presented as a plain list of links. By focusing on just one website per day on CSotD, and at the same time building an archive, Davis was bringing a sense of exploration and serendipity to the Web.

![CSotD screenshot](/assets/images/csotd-screenshot-mirrored.jpg)
*Another CSotD screenshot, this time from [The World Wide Web Unleashed](https://archive.org/details/worldwidewebunle0000dece/), a 1995 book by John December and Neil Randall.*

According to [an introductory post on Verevolf](https://web.archive.org/web/20220520153106/https://verevolf.com/archives/1209), Davis didn't necessarily see himself as a *web designer*. He calls himself "the first web design critic and a major web design influencer in the 1990’s at the beginnings of the World Wide Web." 

The "influencer" label is partly due to his later role as a founding member of the the [Web Standards Project](/p/1998-mozilla-w3c-dom-wasp/) (WaSP) in 1998, alongside Jeffrey Zeldman and others. But Davis also represents a turning point in the early history of web design itself. Whereas [GNN's Jennifer Niederst Robbins](/p/1993-global-network-navigator/) was fundamentally a visual designer, concerned with how web pages looked, Davis worked at the editorial layer — shaping how people discovered and navigated the early Web.
...
Like most other website pioneers, Davis [credits the Mosaic browser](https://web.archive.org/web/20220629123512/https://verevolf.com/archives/1241) for introducing him to the Web. He'd already built a Gopher server for his ISP employer, and soon after he was shown Mosaic. "It was early 1994 and that was the moment my autistic obsession with the web began," he wrote in April 2022.
...
![Cool Stuff on the Internet](/assets/images/cool-stuff-on-the-internet-1994.jpg)
*CSotD wasn't the only site showcasing "cool stuff", as this 1994 screenshot shows. Via [Mosaic Quick Tour for Windows](https://archive.org/details/mosaicquicktourf00bran/), a 1994 book by Gareth Branwyn.*

What was "cool" was an arbitrary decision, though. According to [a 2014 analysis](https://archive.fo/ftEiB#selection-613.0-613.22) by ​Megan Sapnar Ankerson, an associate professor in communications and media at the University of Michigan, Davis' selections were completely subjective:
...
![Zeldman interview with Glenn Davis, 1999](/assets/images/zeldman-coolsite.jpg)
*Zeldman interview with Glenn Davis, 1999.*
...
In December 1994, Denis Howe, a PhD student from Imperial College in London, created a web page called [EUROPa](https://foldoc.org/europa.html) — an acronym for "Expanding Unidirectional Ring Of Pages." The goal was to provide "a different way to connect up and explore the World-Wide Web." 
...
![EUROPa web page](/assets/images/europa-webring.png)
*EUROPa web page; 2006 screenshot [via Wayback Machine](https://web.archive.org/web/20060621212107/https://foldoc.org/europa.html).*
...
The following year, a teenager named Sage Weil automated Howe's idea [using a CGI script](https://web.archive.org/web/20000815053629/http://builder.cnet.com/Business/Innovators97/ss18.html) and launched Webring.com, a service eventually acquired by Geocities. 
