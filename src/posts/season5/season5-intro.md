...
![Web design books](/assets/images/web-design-feature-season5.jpg){loading="eager"}
*Web design books; by Phillip Chee [on Flickr](https://www.flickr.com/photos/pchee/4342855626/), February 2010.*
...
![Molly Holzschlag, 2009](/assets/images/4114585993_6b16af7cbd_o.jpg)
*Molly Holzschlag, Future of Web Design Conference, NYC, 2009; [photo by Chris Casciano](https://www.flickr.com/photos/placenamehere/4114585993/).*

As with [previous seasons of Cybercultural](/seasons/), my ultimate aim is to turn this into a book. I've already created an outline, with the following four sections:
...
The resulting book should come out in 2027. Incidentally, another of my projects this year is to turn [season 4](/season4/) — about the birth of digital culture in the 1990s and early-2000s — into an ebook, hopefully coming out later this year.
...
![Auriea Harvey, 2006](/assets/images/102694510_c2d1792087_o.jpg)
*Auriea Harvey, creator of an award-winning experimental website in the 90s called Entropy8, speaking at ArtefactFestival in 2006. Alongside is her collaborator (and partner) Michaël Samyn and they're discussing their interactive site, [The Endless Forest](https://tale-of-tales.com/TheEndlessForest/index.html). Photo [by yhancik](https://www.flickr.com/photos/yhancik/102694510/).*

But after the first decade of the web, the story of web design becomes more complicated. 

While the blogosphere continued to expand over the 2000s, attempts to create a fully distributed social network — using blog comments, trackback, and RSS syndication — began to fizzle out. Centralized social networks and social media services, like [Facebook](/p/internet-2007/) and [Twitter](/p/twitter-in-2007-key-facts/), arose during this decade and made it much easier for people to express themselves on the web *without* needing to design or manage a website or blog. As mainstream people joined the social web during late 2000s and into the 2010s, typically it was via a corporate offering like Facebook, Twitter, or even the ill-fated Google+.

Of course, there was a design cost to the growing influence of social media. It meant less visual creativity on the web, because social media templates were restrictive — especially once Facebook usurped MySpace, which had at least [allowed users to add custom HTML](/p/myspace-2003/). On Facebook, the most creative thing you could do was add a feature image (as long as it conformed to set dimensions and didn't upset Facebook's moderators). 

![View source article, A List Apart, 2003](/assets/images/a-list-apart-2003.jpg)
*A 2001 article on A List Apart (screenshot: [April 2003](https://web.archive.org/web/20030412153420/http://www.alistapart.com/stories/basics/)); the 'view source' philosophy filtered into the mainstream thanks to MySpace, but Facebook didn't allow custom HTML.*
...
This transition to apps took a few years to play out, because at first it was thought HTML5 — also released in 2008 — would enable web designers to build [cross-platform mobile websites](/p/049-rww-mobile-summit-may2010/). Facebook famously created an HTML5 app for iPhone and Android, located at m.facebook.com; it didn't ditch this strategy until 2012 (another reason that year is my stopping point in this history).

![RWW mobile apps 2010](/assets/images/rww-mobile-browser-and-app-2010.jpg)
*My tech blog, ReadWriteWeb, on mobile in 2010: native iOS app on the left, HTML on the right.*
...
Last but not least, despite the rising dominance of proprietary social media platforms, the blogosphere didn't entirely die off. There was — and still is — a small, but significant, movement called the "[indie web](https://indieweb.org/)," members of which continue to build creative, expressive websites to this day.
...
Partly it comes from the top performing article on Cybercultural last year: [The 3 Gurus of 90s Web Design: Zeldman, Siegel, Nielsen](/p/web-design-1997/). That post really struck a chord with people, and made the front page of Hacker News last May. I also enjoyed writing it, because I have fond memories of that era of the web. I was just getting started in the industry at that time; I was creating my own websites in the mid-to-late 90s and trying to learn as much as I could from well-known designers like Zeldman, Siegel and Nielsen.
...
![classic web design books](/assets/images/90s-web-designers-feature.jpg)
*Three classic web design books on my bookshelf.*
